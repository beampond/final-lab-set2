...
INSERT INTO users (username, email, password_hash, role) VALUES
  ('alice', 'alice@lab.local', '$2b$10$iZyTeBnNNMliSO6IrS6tEuFYIqQEkqmUY77cx.IpitW.cQ3C2nc02', 'member'),
  ('bob',   'bob@lab.local',   '$2b$10$/Sbj.cQeZ5ZT2BzBDMUK9eJYR2OsZ.1fLdYn7YK8Gf.bp5iRXkube',   'member'),
  ('admin', 'admin@lab.local', '$2b$10$tywjSkjiZJr66vqv4ItJhOOC/0VhBOIun8mPS/m2b1NnaFerCyIdS','admin')
